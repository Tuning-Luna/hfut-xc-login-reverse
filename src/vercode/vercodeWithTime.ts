...
export function getVercodeWithTime() {
  const time = Date.now()
  return axios.get("https://cas.hfut.edu.cn/cas/vercode", {
    params: {
      time: time,
    },
    ...
    headers: {
      ...
      Cookie:
        "SESSION=54c76b92-2ab7-4ea1-9a25-5ced6af154f1; JSESSIONID=8a348ee0a21940e7b65767f22b01a25b; LOGIN_FLAVORING=istkvhkqyiatht8q",
    },
  })
}
